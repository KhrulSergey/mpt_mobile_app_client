...
export default (state = INITIAL_STATE, action) => {
    ...
    switch (type) {
        ...
        case FILTER_COMPANIES_REGION_POPULATE:
            return populateFilter(state, payload);
        case FILTER_COMPANIES_REGION_VISIBILITY_TOGGLE:
            return toggleVisibility(state, payload);
        case FILTER_COMPANIES_REGION_TOGGLE:
            return toggleRegionSelection(state, payload);
        case FILTER_COMPANIES_DISTRICT_TOGGLE:
            return toggleDistrictSelection(state, payload);
        case FILTER_COMPANIES_REGION_RESET:
            return resetGroupedFilter(state);
        case FILTER_COMPANIES_REGION_FILTER:
