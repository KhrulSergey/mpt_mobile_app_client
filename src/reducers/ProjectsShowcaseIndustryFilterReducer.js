...
export default (state = INITIAL_STATE, action) => {
    ...
    switch (type) {
        ...
        case FILTER_PROJECTS_SHOWCASE_INDUSTRY_POPULATE:
            return populateFilter(state, payload);
        case FILTER_PROJECTS_SHOWCASE_INDUSTRY_VISIBILITY_TOGGLE:
            return { ...state, ...payload, updated_at: Date.now() };
        case FILTER_PROJECTS_SHOWCASE_INDUSTRY_TOGGLE:
            return toggleItemSelection(state, payload);
        case FILTER_PROJECTS_SHOWCASE_INDUSTRY_RESET:
            return resetFilter(state);
        case FILTER_PROJECTS_SHOWCASE_INDUSTRY_FILTER:
