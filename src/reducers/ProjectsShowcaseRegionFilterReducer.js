...
export default (state = INITIAL_STATE, action) => {
    ...
    switch (type) {
        ...
        case FILTER_PROJECTS_SHOWCASE_REGION_POPULATE:
            return populateFilter(state, payload);
        case FILTER_PROJECTS_SHOWCASE_REGION_VISIBILITY_TOGGLE:
            return { ...state, ...payload, updated_at: Date.now() };
        case FILTER_PROJECTS_SHOWCASE_REGION_TOGGLE:
            return toggleRegionSelection(state, payload);
        case FILTER_PROJECTS_SHOWCASE_DISTRICT_TOGGLE:
            return toggleDistrictSelection(state, payload);
        case FILTER_PROJECTS_SHOWCASE_REGION_RESET:
            return resetGroupedFilter(state);
        case FILTER_PROJECTS_SHOWCASE_REGION_FILTER:
