...
import { applyTextFilter, divideArray, toggleItemSelection, resetFilter } from './FilterHelpers';
...
export default (state = INITIAL_STATE, action) => {
    ...
    switch (type) {
        ...
        case FILTER_COMPANIES_INDUSTRY_POPULATE:
            return populateFilter(state, payload);
        case FILTER_COMPANIES_INDUSTRY_VISIBILITY_TOGGLE:
            return toggleVisibility(state, payload);
        case FILTER_COMPANIES_INDUSTRY_TOGGLE:
            return toggleItemSelection(state, payload);
        case FILTER_COMPANIES_INDUSTRY_RESET:
            return resetFilter(state);
        case FILTER_COMPANIES_INDUSTRY_FILTER:
